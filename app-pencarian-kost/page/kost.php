		    ...
		    <div class="panel panel-info">
		        ...
		        <div class="panel-body">
		            <table class="table table-condensed">
                      ...
                      <?php
                      $no = 1;
                      if ($query = $connection->query("SELECT * FROM kost WHERE id_pemilik=$_SESSION[id]")):
                        ...
                        echo "<tr>
                          ...
                          <td>" . $row['harga_3bulan'] * 2 . "</td>
                          <td>" . $row['harga_3bulan'] * 4 . "</td>
                          <td>
                            <a class='view-map' href='#top'
                              data-id='$row[id_kost]'
                              data-nama='$row[nama]'
                              data-tersedia='$row[tersedia]'
                              data-lat='$row[latitude]'
                              data-lng='$row[longitude]'
                              data-harga3='$row[harga_3bulan]'
                              data-harga6='" . $row['harga_3bulan'] * 2 . "'
                              data-hargatahun='" . $row['harga_3bulan'] * 4 . "'>
                              $row[alamat]
                            </a>
                          </td>

...
<body id="top">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php" style="color: white;">Carii Panam Kost ID</a>
      </div>
  ...
  <script type="text/javascript">
    const markerImage = 'assets/img/marker.png';
    const myCurrentLocationMarker = 'assets/img/mylocation-marker.png';
  </script>
